...
import { supabase_admin } from "../database"; // Ensure this path is correct for your supabase client
...
export default function Dashboard() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      // This is much more stable for mobile connections
      ...
      alert("Mobile upload failed. Please ensure you are on a stable connection.");
